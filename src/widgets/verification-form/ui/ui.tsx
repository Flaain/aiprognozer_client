...
import { useVerificationForm } from '../model/useVerificationForm';

export const VerificationForm = () => {
    const { error, isLoading, isSubmitButtonDisabled, onChange, onSubmit, one_win_id } = useVerificationForm();
