...
export type TypographyVariant = 'primary' | 'secondary' | 'accent' | 'error';
export type TypographySize = 'base' | 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' | '5xl' | '6xl';
export type TypographyWeight = 'thin' | 'normal' | 'medium' | 'semibold' | 'bold' | 'extrabold';
...
const typographyVariants = cva('text-center', {
    variants: {
        variant: {
            primary: 'text-primary-white',
            secondary: 'text-primary-white-secondary',
            accent: 'text-primary-blue',
            error: 'text-primary-error'
        },
        size: {
            base: 'text-base max-sm:text-[14px]',
            xs: 'text-xs',
            sm: 'text-sm',
            md: 'text-md',
...
export const Typography: TypographyComponent = forwardRef(<T extends React.ElementType = 'span'>(props: TypographyProps<T>, ref: PolymorphicRef<T>) => {
